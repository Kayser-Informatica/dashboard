    ...
    <div class="app-shell">
        ...
        <section class="metrics-grid" aria-label="Indicadores operacionais">
            <article class="metric-card metric-card--total">
                ...
                <div class="metric-value-row">
                    <span class="metric-value" id="metric-total"><?php echo e($metrics['total']); ?></span>
                </div>
            ...
            <article class="metric-card metric-card--online">
                ...
                <div class="metric-value-row">
                    <span class="metric-value" id="metric-online"><?php echo e($metrics['online']); ?></span>
                </div>
                <div class="metric-note">Healthcheck status OK</div>
            </article>

            <article class="metric-card metric-card--attention <?php echo e($metrics['attention'] > 0 ? 'has-attention' : ''); ?>">
                <div class="metric-header">
                    <span class="metric-label">Atenção / Falhas</span>
                    <span class="metric-icon">▲</span>
                </div>
                <div class="metric-value-row">
                    <span class="metric-value" id="metric-attention"><?php echo e($metrics['attention']); ?></span>
                </div>
            ...
            <article class="metric-card metric-card--backups">
                ...
                <div class="metric-value-row">
                    <span class="metric-value" id="metric-backups"><?php echo e($metrics['backups']); ?></span>
                </div>
        ...
        <section class="systems-wrapper" aria-labelledby="systems-title">
            <div class="section-bar">
                <div class="section-title-group">
                    ...
                    <span class="section-badge" id="systems-count-badge"><?php echo e($systems->count()); ?> sistema(s)</span>
                </div>
                ...
                <div class="systems-grid" id="systems-container">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $systems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $system): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="system-card" id="system-card-<?php echo e($system->slug); ?>" data-slug="<?php echo e($system->slug); ?>">
                                <div class="system-card-head">
                                    <div class="system-identity">
                                        <h3 class="system-name"><?php echo e($system->name); ?></h3>
                                        <span class="system-slug">/<?php echo e($system->slug); ?></span>
                                    </div>
                                    <span class="status-chip status--<?php echo e($system->last_health_status); ?>">
                                        <?php echo e(match ($system->last_health_status) { 'ok' => 'Operacional', 'failed' => 'Falha', default => 'Sem dados' }); ?>

                                    </span>
                                </div>

                                <?php if($system->last_health_status === 'failed' && $system->last_health_message): ?>
                                    <div class="health-message-banner">
                                        <span>⚠️ <?php echo e($system->last_health_message); ?></span>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="system-meta-grid">
                                    <div class="meta-item">
                                        ...
                                        <span class="meta-value meta-ip"><?php echo e($system->external_ip ?? 'Não informado'); ?></span>
                                    </div>
                                    <div class="meta-item">
                                        <span class="meta-label">Último healthcheck</span>
                                        <span class="meta-value"><?php echo e($system->last_health_at?->diffForHumans() ?? 'Aguardando'); ?></span>
                                    </div>
                                    <div class="meta-item">
                                        <span class="meta-label">Último backup</span>
                                        <span class="meta-value"><?php echo e($system->last_backup_at?->diffForHumans() ?? 'Nenhum recebido'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="backups-area">
                                    <div class="backups-heading">
                                        ...
                                        <span class="backups-count"><?php echo e($system->backup_logs_count); ?> registro(s)</span>
                                    </div>
                                    <?php if($system->backupLogs->isEmpty()): ?>
                                        <div class="empty-backups">Nenhum log de backup recebido.</div>
                                    <?php else: ?>
                                        <div class="backups-list">
                                            <?php $__currentLoopData = $system->backupLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="backup-row">
                                                    <span class="backup-file" title="<?php echo e($backup->original_filename); ?>"><?php echo e($backup->original_filename); ?></span>
                                                    <span class="backup-date"><?php echo e($backup->received_at->format('d/m H:i')); ?></span>
                                                    <span class="backup-size"><?php echo e(number_format($backup->file_size / 1024, 1, ',', '.')); ?> KB</span>
                                                    <span class="backup-tag backup-tag--<?php echo e($backup->status); ?>"><?php echo e($backup->status); ?></span>
                                                </div>
        ...
        <footer class="footer">
            ...
            <div class="footer-right">
                <span id="last-sync-time">Última checagem: <?php echo e(now()->format('H:i:s')); ?></span>
                <span>•</span>
...
<?php /**PATH /home/helitto/projects/sistemas-dashboard/resources/views/dashboard.blade.php ENDPATH**/ ?>