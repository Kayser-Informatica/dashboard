...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Linguagem de Validação (Português do Brasil)
    |--------------------------------------------------------------------------
    */
    ...
    'boolean' => 'O campo :attribute deve ser verdadeiro ou falso (true/false, 1/0).',
    ...
    'dimensions' => 'O arquivo :attribute possui dimensões de imagem inválidas.',
    ...
    'password' => [
        ...
        'uncompromised' => 'O campo :attribute fornecido apareceu em um vazamento de dados. Por favor, escolha outro.',
    ],
    ...
    */
    'attributes' => [
        ...
        'grace_minutes' => 'tolerância em minutos',
